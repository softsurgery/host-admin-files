...
<body>
	...
	<div class="section">
		<div class="container">
			...
			<form method="POST" id="upload_form" enctype="multipart/form-data">
				...
				<button type="button" value="Upload" class="btn" id="submit">Upload</button>
					...
					for ($i = 0; $i < count($files); $i++) {
						...
						<div id='$files[$i]'>
							...
							<div class='everythingOnOneLine'>
								...
								<button type='button' class='btn ajax-delete' value='$files[$i]'>
	...
	<script>
		...
		function completeHandler(num, event) {
			$("#progress-bar-sh-" + num).css({
				display: "none"
			});
			$("#loaded_n_total-" + num).css({
				display: "none"
			});
			$("#shakil-" + num).css({
				display: "none"
